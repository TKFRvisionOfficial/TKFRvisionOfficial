...
- [MarcelCoding/bszet-vplan](https://github.com/MarcelCoding/bszet-vplan) ([v1.2.5](https://github.com/MarcelCoding/bszet-vplan/releases/tag/v1.2.5), today) - Automatically monitors bszet dd timetable for changes and sends notifications.
