...
- [MarcelCoding/api.m4rc3l.de](https://github.com/MarcelCoding/api.m4rc3l.de) (6 days ago)
...
- [spring-projects-experimental/spring-native](https://github.com/spring-projects-experimental/spring-native) ([0.10.5](https://github.com/spring-projects-experimental/spring-native/releases/tag/0.10.5), 1 day ago) - Spring Native provides beta support for compiling Spring applications to native executables using GraalVM native-image compiler.
- [MarcelCoding/node-red-docker](https://github.com/MarcelCoding/node-red-docker) ([v0.3.6](https://github.com/MarcelCoding/node-red-docker/releases/tag/v0.3.6), 2 days ago) - Node-RED Docker image with dashboard nodes and a dark theme
- [many-passwords/many-passwords](https://github.com/many-passwords/many-passwords) ([500](https://github.com/many-passwords/many-passwords/releases/tag/500), 1 week ago) - Default password for each devices. 🐱‍💻 Leave a star if you like this project! (that motivates me)⭐️
