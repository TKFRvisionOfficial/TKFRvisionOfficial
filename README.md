...
- [MarcelCoding/bszet-vplan](https://github.com/MarcelCoding/bszet-vplan) ([v1.2.13](https://github.com/MarcelCoding/bszet-vplan/releases/tag/v1.2.13), today) - Automatically monitors the BSZET Dresden timetable for changes and sends change notifications. 
