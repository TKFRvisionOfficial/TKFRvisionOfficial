...
- [actions/setup-java](https://github.com/actions/setup-java) ([v2.4.0](https://github.com/actions/setup-java/releases/tag/v2.4.0), 1 day ago) - Set up your GitHub Actions workflow with a specific version of Java
- [influxdata/influxdb-client-java](https://github.com/influxdata/influxdb-client-java) ([v4.0.0](https://github.com/influxdata/influxdb-client-java/releases/tag/v4.0.0), 4 days ago) - InfluxDB 2 JVM Based Clients
- [MarcelCoding/bszet-vplan](https://github.com/MarcelCoding/bszet-vplan) ([v1.1.5](https://github.com/MarcelCoding/bszet-vplan/releases/tag/v1.1.5), 5 days ago)
