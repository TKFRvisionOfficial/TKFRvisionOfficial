...
- [high-octane-dev/rre](https://github.com/high-octane-dev/rre) - An attempt to reimplement the Rhythm Racing Engine (1.0), brought to you by a bunch of clever folks. (1 year ago)
...
- [offsetting/offsetting](https://github.com/offsetting/offsetting) ([v0.3.0](https://github.com/offsetting/offsetting/releases/tag/v0.3.0), 1 week ago) - A collection of modding tools based on the libraries created by Team Offsetting.
...
- [hedge-dev/UnleashedRecomp](https://github.com/hedge-dev/UnleashedRecomp) - An unofficial PC port of the Xbox 360 version of Sonic Unleashed created through the process of static recompilation. (10 months ago)
