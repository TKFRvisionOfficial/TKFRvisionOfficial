...
- [actions/setup-java](https://github.com/actions/setup-java) ([v3.2.0](https://github.com/actions/setup-java/releases/tag/v3.2.0), 1 day ago) - Set up your GitHub Actions workflow with a specific version of Java
- [MarcelCoding/nova](https://github.com/MarcelCoding/nova) ([v3.0.5](https://github.com/MarcelCoding/nova/releases/tag/v3.0.5), 6 days ago) - Nova is a framework on top of spring boot. It aims to provide nice additions to the spring ecosystem.
...
- [Added .well-known docs](https://github.com/felbinger/AdminGuide/pull/68) on [felbinger/AdminGuide](https://github.com/felbinger/AdminGuide) (1 day ago)
- [Added .well-known docs](https://github.com/felbinger/AdminGuide/pull/67) on [felbinger/AdminGuide](https://github.com/felbinger/AdminGuide) (1 day ago)
