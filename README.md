...
- [MarcelCoding/api.m4rc3l.de](https://github.com/MarcelCoding/api.m4rc3l.de) (3 days ago)
- [MarcelCoding/m4rc3l.de](https://github.com/MarcelCoding/m4rc3l.de) - My personal small font page. (4 days ago)
- [MarcelCoding/underscore](https://github.com/MarcelCoding/underscore) - url shortener (5 days ago)
...
- [MarcelCoding/node-red-docker](https://github.com/MarcelCoding/node-red-docker) ([v0.3.5](https://github.com/MarcelCoding/node-red-docker/releases/tag/v0.3.5), 1 day ago) - Node-RED Docker image with dashboard nodes and a dark theme
- [many-passwords/many-passwords](https://github.com/many-passwords/many-passwords) ([500](https://github.com/many-passwords/many-passwords/releases/tag/500), 4 days ago) - Default password for each devices. 🐱‍💻 Leave a star if you like this project! (that motivates me)⭐️
- [influxdata/influxdb-client-java](https://github.com/influxdata/influxdb-client-java) ([v3.4.0](https://github.com/influxdata/influxdb-client-java/releases/tag/v3.4.0), 4 days ago) - InfluxDB 2 JVM Based Clients
