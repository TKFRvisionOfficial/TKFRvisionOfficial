...
- [dd-ix/nix-config](https://github.com/dd-ix/nix-config) - NixOS deployments of DD-IX (3 weeks ago)
...
- [TKFRvisionOfficial/dmx-rdm-rs](https://github.com/TKFRvisionOfficial/dmx-rdm-rs) - Rust library for communicating DMX512 (ANSI E1.11) and DMX-RDM (ANSI E1.20) over a RS485 bus by using interchangeable drivers. (10 months ago)
