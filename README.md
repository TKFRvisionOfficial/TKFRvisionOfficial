...
- [MarcelCoding/bszet-vplan](https://github.com/MarcelCoding/bszet-vplan) ([v1.2.9](https://github.com/MarcelCoding/bszet-vplan/releases/tag/v1.2.9), 6 days ago) - Automatically monitors bszet dd timetable for changes and sends notifications.
